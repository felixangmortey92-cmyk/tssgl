...
export const coreValues = [
  {
    title: "Safety First",
    description: "Conducting operations safely is our paramount concern." //[cite: 14]
  },
  {
    title: "Efficiency",
    description: "24/7 staff ensures a speedy turnaround to avert costly waiting periods at Ghanaian port anchorages." //[cite: 15, 16]
  },
  {
    title: "Integrity",
    description: "Rigorous corporate governance and transparent business practices in every contract."// [cite: 17]
  },
  {
    title: "Win-Win Partnerships",
    description: "Cost-benefit structure that remains standard while offering flexibility for negotiated terms." //[cite: 18]
  }
]
